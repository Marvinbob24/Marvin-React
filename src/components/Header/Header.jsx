...
//                         <div className={`dropdown-menu ${isCollectionsOpen ? 'open' : ''}`}>
//                             <div className="dropdown-item">
//                                 <span onClick={() => toggleSubmenu('football')}>
//                                     Football Club <FaAngleRight />
//                                 </span>
//                                 <div className={`dropdown-submenu ${openSubmenus.football ? 'open-submenu' : ''}`}>
...
//                             <div className="dropdown-item">
//                                 <span onClick={() => toggleSubmenu('basketball')}>
//                                     Basketball Club <FaAngleRight />
//                                 </span>
//                                 <div className={`dropdown-submenu ${openSubmenus.basketball ? 'open-submenu' : ''}`}>
...
//                     {user && (
//                         <NavLink to="/Dashboard" onClick={closeMenu} className={({ isActive }) => isActive ? 'active' : ''}>Account</NavLink>
//                     )}
//                     {user?.isAdmin && (
//                         <NavLink to="/admin" onClick={closeMenu} className={({ isActive }) => isActive ? 'active' : ''}>Admin Panel</NavLink>
//                     )}
//                 </nav>
        ...
        <header className={`header ${scrolled ? 'scrolled' : ''}`}>
            <div className="container">
                ...
                <nav className={`nav-links ${isMenuOpen ? 'open' : ''}`}>
                    ...
                    {user && <NavLink to="/dashboard" onClick={closeMenu}>Account</NavLink>}
                    {user?.isAdmin && <NavLink to="/admin" onClick={closeMenu}>Admin Panel</NavLink>}
                </nav>
